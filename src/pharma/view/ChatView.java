...
public class ChatView extends JFrame 
{
    ...
    private void initComponents() {
        ...
        setTitle("Hệ thống chat của HL Pharmacy");
        ...
        b_connect.setText("Kết nối");
        b_connect.setBackground(Color.ORANGE);
        ...
        b_disconnect.setText("Ngắt kết nối");
        b_disconnect.setBackground(Color.ORANGE);
...
//        b_anonymous.setText("Dùng tên bất kì");
//        b_anonymous.setBackground(Color.ORANGE);
...
//        lb_name.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (isConnected == false) 
        {
            ...
            {
                ta_chat.append("Cannot Connect! Try Again. Server có thể đã offline. Hãy khởi động server \n");
                tf_username.setEditable(true);
            }
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        ...
        if (isConnected == false) 
        {
            ...
            {
                ta_chat.append("Cannot Connect! Try Again. Server maybe Off \n");
                tf_username.setEditable(true);
            }
